  ...
  Widget build(BuildContext context) {
    final planetThumbnail = new Container(
      ...
      child: new Hero(
        ...
        child: new Image(
          image: new NetworkImage(planet['imgurl']),
          height: 92.0,
          width: 92.0,
        ),
      ),
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new Row(
            ...
            children: <Widget>[
              new Expanded(
                  flex: horizontal ? 1 : 0, child: _planetValue(value: "7")),
              new Container(
                width: 32.0,
              ),
              new Expanded(
                  flex: horizontal ? 1 : 0, child: _planetValue(value: '1'))
            ],
          ),
        ],
      ),
